...
def prepare_batch_dict_from_ort_outputs(
    ort_outputs, output_names, batch_size=None, cls_preds_normalized=None, device="cuda:0"
):
    """
...
def main():
    ...
    ort_session = ort.InferenceSession(
        os.path.join(args.out_dir, "onnx_trim_post.onnx"), sess_options=sess_options
    )
